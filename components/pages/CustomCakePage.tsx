    ...
    return (
        <div className="pt-24 px-4 max-w-6xl mx-auto">
                ...
                <div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <button
                            ...
                            className="w-full block mx-auto text-center bg-transparent text-brownDark font-bold py-2 px-4 rounded-full border border-brownLighter hover:bg-brownLighter hover:text-white transition hover:cursor-pointer"
                        >
            ...
            <div className="my-8 w-full md:w-[35%] mx-auto flex flex-col sm:flex-row justify-between gap-4">
                <Link
                    href="/shop"
                    className="block mx-auto text-center bg-transparent text-brownDark font-bold py-2 px-4 rounded-full border border-brownLighter hover:bg-brownLighter hover:text-white transition hover:cursor-pointer"
                    >
